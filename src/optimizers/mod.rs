...
//     where
//         T: 'static + Variable<Dim = nalgebra::Const<DIM>, Alias<dtype> = T>,
//         T::Dim: nalgebra::DimNameAdd<T::Dim>,
//         <DefaultAllocator as Allocator<dtype, T::Dim>>::Buffer: Sync + Send,
//         DefaultAllocator: DualAllocator<T::Dim>,
//         O: Optimizer,
//     {
