...
macro_rules! test_lie {
    ($($var:ident),*) => {
        $(
            ...
            #[test]
            fn jacobian(){
                let vec_len = <$var as $crate::variables::MatrixLieGroup>::VectorDim::try_to_usize().unwrap();
                ...
                let $crate::linalg::DiffResult { value: _x, diff: dx } = $crate::linalg::ForwardProp::jacobian_1(rotate, &t);

                let size = <$var as $crate::variables::MatrixLieGroup>::VectorDim::try_to_usize().unwrap();
